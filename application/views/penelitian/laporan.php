...
<main>
  <div class="title">
    <span>Cetak Laporan Pengajuan Penelitian</span>
  ...
  <div class="content">
    ...
    <div class="row">
      <div class="input-field col s12">
        <button class="btn waves-effect waves-light red lighten-2 btn-large" type="submit" name="action" formtarget="_blank">Cetak
